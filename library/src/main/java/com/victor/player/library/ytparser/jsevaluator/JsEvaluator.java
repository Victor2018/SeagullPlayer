...
import com.victor.player.library.ytparser.jsevaluator.interfaces.JsEvaluatorInterface;
import com.victor.player.library.ytparser.jsevaluator.interfaces.WebViewWrapperInterface;
...
public class JsEvaluator implements CallJavaResultInterface, JsEvaluatorInterface {
	...
	public void evaluate(String jsCode, JsCallback resultCallback) {
		final String js = getJsForEval(jsCode);

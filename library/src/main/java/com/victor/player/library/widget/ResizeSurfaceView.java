...
//        Log.d("@@@@", "onMeasure: width" + width + "    height:" + height);
        ...
        //如果设置了比例
        switch (screenType) {
            case PlayConfig.ScreenScale.SCALE_ORIGINAL:
                width = mVideoWidth;
                height = mVideoHeight;
                break;
            case PlayConfig.ScreenScale.SCALE_16_9:
                ...
                break;
            case PlayConfig.ScreenScale.SCALE_4_3:
                if (height > width / 4 * 3) {
                    height = width / 4 * 3;
                } else {
                    width = height / 3 * 4;
...
//                Log.d("@@@@", "onMeasure 4:3 : width" + width + "    height:" + height);
                break;
            case PlayConfig.ScreenScale.SCREEN_SCALE_MATCH_PARENT:
                width = widthMeasureSpec;
                height = heightMeasureSpec;
                break;
            case PlayConfig.ScreenScale.SCREEN_SCALE_CENTER_CROP:
